...
<section class="content">
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <a href="<?= base_url('master/kelas/print_data'); ?>" class="btn btn-sm btn-primary btn-flat pull-right" data-toggle="tooltip" data-placement="top" title="Cetak Data" target="_blank"><i class="fa fa-print"></i></a>
            <a href="<?= base_url('master/kelas'); ?>" class="btn btn-sm btn-primary btn-flat pull-right" data-toggle="tooltip" data-placement="top" title="Refresh"><i class="fa fa-refresh"></i></a>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kelas_kd" name="kelas_kd" placeholder="Ex: 1A" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="kelas_nama">Nama Kelas<span class="text-red">*</span></label>
                                <input type="text" class="form-control" id="kelas_nama" name="kelas_nama" placeholder="Ex: Kelas Satu A" required>
                            </div>
                        </div>
                    </div>
                </div>
