...
<section class="content">
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <a href="<?= base_url('master/guru/print_data'); ?>" class="btn btn-sm btn-primary btn-flat pull-right" data-toggle="tooltip" data-placement="top" title="Cetak Data" target="_blank"><i class="fa fa-print"></i></a>

            <a href="<?= base_url('master/guru'); ?>" class="btn btn-sm btn-primary btn-flat pull-right" data-toggle="tooltip" data-placement="top" title="Refresh"><i class="fa fa-refresh"></i></a>
            <a href="<?= base_url('master/guru/keyAll'); ?>" class="btn btn-sm btn-primary btn-flat pull-right" data-toggle="tooltip" data-toggle="tooltip" data-placement="top" title="Aktifkan akun"><i class="fa fa-key"></i></a>
            ...
            <table class="table table-bordered table-striped table-hover datatable">
                ...
                <tbody>
                    ...
                    foreach ($guru as $row) : ?>
                        <tr>
                            <td><?= $n++ . '.'; ?></td>
                            <td><a href="#modal-add" data-toggle="modal" onclick="submit(<?= $row->idguru; ?>)"><i class="fa fa-edit"></i></a>
                            </td>
                            <td><?= $row->nip; ?></td>
                            <td><?= $row->nama; ?></td>
                            ...
                            <td>
                                <?php if (check_user($row->nip) == 0) : ?>
                                    <a href="<?= base_url('master/guru/key/') . $row->idguru; ?>" class="btn btn-xs btn-default text-aqua" data-toggle="tooltip" data-placement="top" data-title="Aktifkan pengguna"><i class="fa fa-key"></i></a>
                                <?php endif; ?>
                                <a href="#" class="btn btn-xs btn-default text-red" data-toggle="tooltip" data-placement="top" data-title="Hapus" onclick="hapus(<?= $row->idguru; ?>)"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nip" name="nip" placeholder="Ex: 198609262015051001" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
